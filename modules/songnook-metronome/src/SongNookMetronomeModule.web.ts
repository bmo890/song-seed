...
class SongNookMetronomeModule extends NativeModule<SongNookMetronomeModuleEvents> {
...
export default registerWebModule(SongNookMetronomeModule, "SongNookMetronome");
