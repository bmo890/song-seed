...
import type {
  ...
  SongNookPitchShiftModuleEvents,
} from "./SongNookPitchShift.types";

declare class SongNookPitchShiftModule extends NativeModule<SongNookPitchShiftModuleEvents> {
  isAvailable(): boolean;
...
export default requireOptionalNativeModule<SongNookPitchShiftModule>("SongNookPitchShift");
