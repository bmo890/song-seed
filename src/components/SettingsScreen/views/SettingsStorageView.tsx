  ...
  return (
    ...
    >
      <PageIntro
        ...
        subtitle="SongNook keeps your live library in app-managed storage on this device. Recorded and imported audio is copied into SongNook storage, while archived workspaces keep compressed packages until you restore them."
      />
        ...
        <>
          ...
          <View style={styles.settingsSection}>
            ...
            <View style={styles.settingsSummaryPanel}>
              ...
              <StorageMetricRow
                ...
                detail={`${diagnostics.storageReport.archivePackages.fileCount} archive package${diagnostics.storageReport.archivePackages.fileCount === 1 ? "" : "s"} stored in SongNook app storage.`}
              />
              <StorageMetricRow
          ...
          <View style={styles.settingsSection}>
            ...
            <View style={styles.settingsSummaryPanel}>
              ...
              />
              <StorageMetricRow
                label="All SongNook managed storage"
          ...
          >
            <View style={styles.settingsOptionStack}>
              ...
              <View style={styles.settingsSummaryPanel}>
                ...
                <Text style={styles.settingsSummaryMeta}>
                  Paths are shown here for support use only. SongNook manages the live storage location automatically.
                </Text>
                <StoragePathRow
