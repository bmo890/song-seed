...
export const baseStyles = {
  ...
  pageTitleCompact: { fontSize: 20, fontFamily: "Lora_600SemiBold", color: colors.textPrimary },
  titleInlineWrap: {
    marginHorizontal: 8,
    position: "relative",
    alignSelf: "stretch",
  },
  // The title field (2026-09-15): one soft-key shell (radii.lg, hairline) for
  // every place a title is typed, Lora because a title is content. The trailing
  // gutter is sized by TitleInput to the keys it actually shows — the old fixed
  // 64pt reserved room for two keys and left a dead margin when one was hidden.
  titleInlineInput: {
    borderWidth: 1,
  ...
  // Button language (locked 2026-07-24): soft keys at radii.lg, ~38px tall.
  // Color carries tier, not heft. Stadium round (999) retired on text buttons.
  primaryBtn: {
    // terracotta wash, primary tonal fill (no matching token in tokens.ts)
